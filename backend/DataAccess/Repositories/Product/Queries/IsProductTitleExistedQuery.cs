...
{
    public class IsProductTitleExistedQuery
    {
        private const string query = @"SELECT 1 FROM Products WHERE ProductName = @ProductName";
        public static async Task<bool> ExcuteAsync(string ProductName)
        {
