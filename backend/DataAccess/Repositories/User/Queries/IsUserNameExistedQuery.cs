...
{
    public class IsUserNameExistedQuery
    {
        private const string query = @"SELECT 1 FROM Users WHERE UserName = @UserName";

        public static async Task<bool> ExcuteAsync(string UserName)
        {
